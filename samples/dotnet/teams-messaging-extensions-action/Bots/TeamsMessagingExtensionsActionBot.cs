...
namespace Microsoft.BotBuilderSamples.Bots
{
    public class TeamsMessagingExtensionsActionBot : TeamsActivityHandler
    {
        ...
        protected override async Task<MessagingExtensionActionResponse> OnTeamsMessagingExtensionSubmitActionAsync(ITurnContext<IInvokeActivity> turnContext, MessagingExtensionAction action, CancellationToken cancellationToken)
        {
            ...
            return UserEchoResponse(turnContext, action);
        ...
        private MessagingExtensionActionResponse CreateCardCommand(ITurnContext<IInvokeActivity> turnContext, MessagingExtensionAction action)
        {
            ...
            var card = new HeroCard
            {
                Title = "Title: " + createCardData.Title,
                Subtitle = "Created On: " + DateTime.Now.ToShortDateString(),
                Text =  "Content: " + createCardData.Text,
            };
        ...
        private MessagingExtensionActionResponse UserEchoResponse(ITurnContext<IInvokeActivity> turnContext, MessagingExtensionAction action)
        {
            var data = "Custom data: " + action.Data.ToString() + " modifed by .NET client app";
            return new MessagingExtensionActionResponse
            {
                ComposeExtension = new MessagingExtensionResult
                {
